            ...
            <div class="content-page" dir="rtl">
                <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h2 class="mt-0 mb-3" style="text-align:center;">ثبت فروش</h2>
                     ...
                     <!-- Form row -->
                                ...
                                <div class="card-box" style="box-shadow: 0 20px 35px 0 lightgrey">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="inputEmail4" class="col-form-label">نام</label>
                                            ...
                                            <div class="form-group col-md-12">
                                                <label for="inputPassword4" class="col-form-label">شماره تماس</label>
                                      ...
                                      <div class="card-box" style="box-shadow: 0 25px 35px 0 lightgrey">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">مجموع</label>
                                                <input type="number"  name="sub_total" class="form-control" id="sub_total">
                                            </div>
                                          
                                             <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">تخفیف</label>
                                                <input type="text" class="form-control" id="dis" name="dis">
                                            </div>
                                             <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">بعد از تخفیف</label>
                                                <input type="number" class="form-control" id="net_total" name="net_total">
                                            </div>
                                             <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">رسید پول</label>
                                                <input type="number" class="form-control" id="paid" name="paid">
                                            </div>
                                             <div class="form-group col-md-6">
                                                <label for="inputCity" class="col-form-label">باقی</label>
                            ...
                            <div class="col-md-8">
                                 <div class="form-group" id="rows bg-info" style="box-shadow: 0 25px 35px 0 lightgrey">
                                          ...
                                          <table class="table table-bordered table-striped table-responsive" id="user_table">
                                           <thead>
                                            <tr>
                                                <th width="35%">محصولات</th>
                                                <th width="25%">تعداد</th>
                                                <th width="45%">قیمت</th>
                                                <th width="35%">مجموع</th>
                                                <th width="30%">عمل</th>
                                            </tr>
                                           </thead>
                                           <tbody>
                        ...
                        <!-- end row -->        
                                        ...
                                        <button type="submit" class="btn btn-danger btn-block">ذخیره</button>
              ...
              @section('scripts')
                 ...
                 function dynamic_field(number)
                 {
                  ...
                  html = '<tr>';
                        ...
                        html += '<td>AFN <span class="total">0</span></td>';
