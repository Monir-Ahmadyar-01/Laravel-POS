            ...
            <div class="content-page">
                <div class="content">
                        ...
                        <div class="row" dir="rtl">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h2 class="mt-0 mb-3" style="text-align:center;">ثبت محصول</h2>
                                    <hr>
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group" >
                                            <label>نام</label>
                                            <input type="text" class="form-control" name="name" ="exampleInputEmail1" aria-describedby="emailHelp" @if (isset($product->name)) value="{{$product->name}}" @else value="{{old('name')}}")
