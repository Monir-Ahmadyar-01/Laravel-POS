            ...
            <div class="content-page">
                <div class="content">
                        ...
                        <div class="row" dir="rtl">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h2 class="mt-0 mb-3" style="text-align:center;">کتگوری</h2>
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" ="exampleInputEmail1" aria-describedby="emailHelp" value="{{@$category->name}}">
