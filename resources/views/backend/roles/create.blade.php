            ...
            <div class="content-page">
                <div class="content">
                        ...
                        <div class="row" dir="rtl">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <h2 class="mt-0 mb-3" style="text-align:center;">صلاحیت</h2>
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" style="float:right;">صلاحیت</label>
                                      ...
                                      <div class="card-header "><h3 style="text-align:center;">اجازه ها</h3></div>
                                        <div class="card-body">
                                            <div class="row">
